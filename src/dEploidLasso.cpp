...
//void DEploidLASSO::updateCoefficient(size_t k, double previousCoefficentValue,
                                     //double gk) {
...
//double DEploidLASSO::updateYReturnDel(size_t k, double gk,
